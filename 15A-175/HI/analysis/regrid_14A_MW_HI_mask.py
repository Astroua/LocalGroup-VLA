...
targ_cube = fifteenA_HI_BC_1_2kms_data_wEBHIS_path("M31_15A_B_C_14A_HI_contsub_width_1_2kms.image.pbcor.EBHIS_feathered.fits")

out_path = fifteenA_HI_BC_1_2kms_data_wEBHIS_path("",
                                                  no_check=True)
reproject_cube(custom_mask_name,
               targ_cube,
               "M31_15A_interactive_mask.fits",
               output_folder=out_path,
               save_spectral=False,
               is_huge=True,
               reproject_type='all',
