...
logprint ("Starting EVLA_pipe_semiFinalBPdcals2.py", logfileout='logs/semiFinalBPdcals2.log')
time_list=runtiming('semiFinalBPdcals2', 'start')
QA2_semiFinalBPdcals2='Pass'

logprint ("Finding a reference antenna for semi-final delay and BP calibrations", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("The pipeline will use antenna "+refAnt+" as the reference", logfileout='logs/semiFinalBPdcals2.log')
...
logprint("Fraction of flagged solutions = "+str(flaggedSolnResult['all']['fraction']), logfileout='logs/semiFinalBPdcals2.log')
logprint("Median fraction of flagged solutions per antenna = "+str(flaggedSolnResult['antmedian']['fraction']), logfileout='logs/semiFinalBPdcals2.log')
...
if (fracFlaggedSolns > critfrac):
    logprint ("Not enough good solutions, trying a different reference antenna", logfileout='logs/semiFinalBPdcals2.log')
    ...
    if (fracFlaggedSolns > critfrac):
        ...
        if (fracFlaggedSolns > critfrac):
            ...
            if (fracFlaggedSolns > critfrac):
                logprint ("Warning, tried several reference antennas, there might be something wrong with your data", logfileout='logs/semiFinalBPdcals2.log')


logprint ("Delay calibration complete", logfileout='logs/semiFinalBPdcals2.log')

logprint ("Plotting delays", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("Initial gain calibration on BP calibrator complete", logfileout='logs/semiFinalBPdcals2.log')
logprint ("Plotting initial phase gain calibration on BP calibrator", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("Bandpass calibration complete", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("Plotting bandpass solutions", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("Plotting complete", logfileout='logs/semiFinalBPdcals2.log')


logprint ("Applying semi-final delay and BP calibrations to all calibrators", logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("Plot calibrated calibrators to check for further flagging/RFI", logfileout='logs/semiFinalBPdcals2.log')
...
showmajorgrid=False
showminorgrid=False
plotfile='semifinalcalibratedcals2.png'
interactive=False
overwrite=True
showgui=False
plotms()
...
logprint ("QA2_delay: "+QA2_delay, logfileout='logs/semiFinalBPdcals2.log')
...
logprint ("QA2_BP: "+QA2_BP, logfileout='logs/semiFinalBPdcals2.log')

if (QA2_delay=='Fail' or QA2_BP=='Fail'):
    QA2_semiFinalBPdcals2='Fail'
elif (QA2_delay=='Partial' or QA2_BP=='Partial'):
    QA2_semiFinalBPdcals2='Partial'

logprint ("QA2 score: "+QA2_semiFinalBPdcals2, logfileout='logs/semiFinalBPdcals2.log')
logprint ("Finished EVLA_pipe_semiFinalBPdcals2.py", logfileout='logs/semiFinalBPdcals2.log')
time_list=runtiming('semiFinalBPdcals2', 'end')
